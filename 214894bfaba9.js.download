__d(
  ...
  65536,
  [65537, 65538, 65539, 65540, 65541, 65542, 65543]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    ...
    (e.strs = [
      ...
      "Report as promoting the sale of inappropriate or adult products?",
      ...
      "Comments identifying victims of self-injury if the comment attacks or makes fun of them.",
      "Toggle audio",
      "To help personalize content, tailor and measure ads, and provide a safer experience, we use cookies. By clicking or navigating the site, you agree to allow our collection of information on and off Instagram through cookies. Learn more, including about available controls:",
      ...
      "When your contacts are on Instagram, you'll see them here.",
      ...
      "Let your friend know they're important to you, and that you are available to talk whenever they need, now and in the future.",
      ...
      "Resend Code.",
      "Push Notifications",
      "We define suicide or self-injury as:",
      ...
      "Back",
      "We'll take a look and send resources to them if they need support. Here's some guidance on how you might help.",
      ...
      "IGTV",
      "Delete All",
      "See which of your friends are on Instagram and choose who to follow.",
      "Get More Help",
      ...
      "Locations",
      "Get Started",
      "If you have permission to share everything in the video including the audio, like the soundtrack or music, you can appeal the block and have your video unblocked. {appeal button}",
      "Profiles",
      "Birthday cupcake",
      "Sunday",
      "Activity",
      ...
      "Regulated Goods",
      "Unfollow {username of the person being unfollowed}?",
      "Restore this video",
      "Forgot Password?",
      "Can’t Send Message",
      ...
      "{count} more",
      "Use Security Code",
      "We take reports seriously, and won't tell {username of the person being reported} who reported them.",
      "Add phone number",
      "Learn More",
      "Followed by {username1} and {username2}",
      "Videos and some digitally-created content that show sexual intercourse, genitals, and close-ups of fully-nude buttocks.",
      "Confirmation Code",
      ...
      "You can also take steps to remove this person from your Instagram experience. We won't let them know.",
      "Use Instagram with",
      ...
      "Some videos of female nipples, but videos of post-mastectomy scarring and women actively breastfeeding are allowed.",
      ...
      "Product details link to scam or fraud",
      ...
      "Block {username of the person being blocked}",
      ...
      "Jan",
      "For the next 60 days, you'll only get password reset emails from devices where you've used Instagram before.",
      "We define sale or promotion of drugs as:",
      "Sent",
      ...
      "Support",
      "This is not a real item for sale",
      "Data Policy",
      "ID Photo",
      ...
      "Manage Contacts",
      "This is inappropriate or has adult products",
      ...
      "Embed Code Copied!",
      "We can only send you a new code every 10 minutes.",
      "Most recent",
      ...
      "Full Name",
      "Use Less Data",
      "If this item violates your intellectual property, visit the {link_to_instagram_help_center} to report an issue.",
      "Can't load stickers",
      "Continue",
      "Download Nametag",
      "Reminder emails",
      ...
      "Information Format",
      "Product details offer to sell explosives",
      "Share",
      "New Posts",
      "Data Policy",
      ...
      "Keep as is",
      "Videos that target private individuals to degrade or shame them.",
      ...
      "Settings on your phone must be changed to let us access your contacts.{new line 1}{new line 2}1.) Open your phone's settings.{new line 3} 2.) Tap Apps & notifications.{new line 4}3.) Tap Instagram Lite.{new line 5}4.) Tap Permissions.{new line 6}5.) Toggle on Contacts.",
      ...
      "Couldn't send code.",
      "Laws in different countries may vary. Visit our Help Center to learn more about reporting an intellectual property violation.",
      "{date} at {time}",
      ...
      "filled in lock icon",
      "Connect",
      "Product details intended to sell or distribute drugs",
      "Add Your Birthday",
      ...
      "Product details that contain inaccurate images, details or descriptions",
      "Comment Options",
      "Sign up",
      ...
      "Go to post",
      "Restricted Account",
      "If you're unable to receive a security code from your authentication app, you can use one of your {=backup codes} .",
      "Next",
      "Done",
      ...
      "Safari",
      "Videos with personal information shared to harass or blackmail people.",
      "1 year old",
      ...
      "Settings",
      "Please copy and include the following Story ID into your intellectual property report to help us identify this content:",
      "Save",
      "Unmute",
      "Post Profile Photo?",
      ...
      "Not Now",
      "Cover Photo",
      "People can't view, like, or comment on your video in locations where it's blocked. Your video is only visible in:",
      ...
      "Find people you know on Instagram and choose who to follow.",
      "Username",
      "th",
      ...
      "Your contacts will be periodically synced and stored on Instagram servers to help you and others find friends. To remove contacts, go to Settings and disconnect.",
      "View Drafts",
      "Backup Codes",
      ...
      "Hi {username}, you previously linked {application name} to Instagram.",
      ...
      "Cancel",
      "More control over what you watch. More videos to explore. All on the app.",
      ...
      "We use these reports as a signal to understand problems we're having with hacked accounts on Instagram. If this account belongs to you or someone you know, you can get help logging in to secure your account. {link to the community guidelines in the help center}",
      "Just one more step: enter the 6-digit code we sent to {phone number}.",
      "See Comment",
      ...
      "Required field",
      "Removed on",
      "If you have permission to share everything in the video including the audio, like the soundtrack or music, you can appeal the removal and have your video re-posted. {appeal button}",
      ...
      "Your Profile Photo Will Also Change on Facebook",
      "Comment Controls",
      "Upload failed.",
      ...
      "We have a zero tolerance policy around threats to post intimate images or videos of others. We define bullying or harassment as:",
      "Switched to Personal Account",
      "SMS sent.",
      "Billing address same as postal address",
      "{weeks}w",
      "Log In to Instagram",
      "Couldn't disable contacts syncing.",
      "Login with Facebook.",
      "Revoke Access",
      "Sent to: {email}",
      "Suggested Accounts",
      ...
      "Complete Profile",
      "Can't Add Account",
      "We have a zero tolerance policy around threats to post intimate images or videos of others.",
      "Account",
      ...
      "There are a few things you can do to remove {username of the person being reported} from your experience on Instagram. We won't let them know.",
      "phone number",
      "If someone is using your photos without your permission or impersonating you. We only review reports sent to us from the person who's being impersonated or a representative of that person (e.g. a parent). If someone you know is being impersonated, please encourage that person to report it.",
      ...
      "Copy Link",
      "th",
      "Comments that encourage violence or attacks on anyone based on their religious, ethnic or sexual background.",
      ...
      "Product details link to spam, scam or fraud",
      ...
      "This appears to be a knock-off or counterfeit item",
      "New Post",
      ...
      "Location icon",
      "Get the app.",
      "Choose a category to see more information about what we remove. We take reports seriously, and won't tell {username of the person being reported} who reported them.",
      "Remember Login Info",
      ...
      "Relationships",
      "Send Confirmation",
      "Unable to Log in With Your Facebook Account, {username}",
      "0 years old",
      "February",
      "Change Your Password to Secure Your Account",
      "Privacy and Security Help",
      "Your feedback is important in helping us keep the Instagram community safe. We'll let you know when we review your report. If we find that this post goes against our {link to the community guidelines in the help center} we may remove the post or disable the account.",
      ...
      "Listen carefully and show care.",
      "Password",
      "Story Video Overlay",
      "Things You Can Do",
      ...
      "Product details offer to sell firearms and ammunition",
      ...
      "Block {username} if you don't want them to see your photos or videos or find you on Instagram.",
      ...
      "Your backup codes can get you back into your account if you aren't able to receive a security code by text. Make sure you keep them in a safe place.",
      ...
      "Posting unusual content",
      "Comments that target private individuals to degrade or shame them.",
      ...
      "Download Data - Part {number}",
      "Only get password reset emails from devices where you've used Instagram before. This setting will last for the next 60 days.",
      "Confirm Your Email to Get Back into Instagram",
      "Comments encouraging or promoting self-injury, which includes suicide, cutting and eating disorders.",
      "Please log in with your Instagram password. Once you log in, you can change your settings to log in with Facebook in the future.",
      "More Information",
      ...
      "Privacy and Security",
      "Videos promoting the use of hard drugs.",
      ...
      "We remove peer-to-peer sales of firearms, explosives and ammunition.",
      "Permissions",
      "I find it offensive",
      ...
      "Write alt text…",
      "Unfollow {username} so you won't see any of their photos or videos in your feed.",
      "Checkout in App",
      "SMS was resent.",
      ...
      "Comments that encourage violence or attack anyone based on who they are.",
      "Tell Us",
      "Remove From Group",
      "Audio",
      ...
      "Music Questions",
      "Required",
      "People can't view, like, or comment on your photo in locations where it's blocked. Your photo is only visible in:",
      "Request Download",
      "Email:",
      "Full Terms",
      "Active 1h ago",
      ...
      "Videos with captions that encourage violence or attack anyone based on who they are.",
      "tapping Donate",
      ...
      "Session updates",
      "Product details link to knock-off or counterfeit item",
      ...
      "Report as promoting knock-off or counterfeit item?",
      ...
      "The pictures or description don't match the item",
      "We define intellectual property violation as:",
      ...
      "Report as promoting the sale of drugs, guns or regulated goods?",
      "Delete",
      "Videos of extreme graphic violence.",
      "Thanks For Submitting Your Information",
      "Submit",
      "Read the Full Data Policy",
      "We define regulated goods as:",
      "Submit",
      ...
      "Videos of hate speech or symbols.",
      "Profile",
      ...
      "Choose a reason for reporting this account.",
      "Find People to Follow",
      "Unsaved Changes",
      ...
      "While we review your report, you can take steps to remove this person from your Instagram experience. We won't let them know.",
      ...
      "Product details show products not for sale",
      ...
      "Peer-to-peer sales of firearms, explosives and ammunition.",
      "Privacy",
      "Product details offer to sell inappropriate or adult products",
      "Replied to a story highlight",
      "This comment is spam or a scam",
      "Get App",
      "There was a problem giving approval.",
      "Authorized by you on",
      "Find {link that reads <resources>} for suicide prevention, substance abuse and more.",
      "Login Activity",
      "Hashtag",
      "Exploring is better in the app",
      "Decline?",
      ...
      "Back To Login",
      "1 week ago",
      "Comments soliciting sexual intercourse on photos or videos of minors.",
      "Videos must be between {minLengthInMinutes} and {maxLengthInMinutes} minutes long.",
      "{previous items}; {following items}",
      "IGTV is Better in the App",
      "Appeal",
      "Posting unusual comments",
      ...
      "We define hate speech or symbols as:",
      "Image from {username}",
      "Aug",
      ...
      "Payments Gift Aid",
      "Change Privacy?",
      "Comments that include copyright or trademark infringement.",
      "Last 4 digits of SSN",
      "Show category on profile",
      "Get the App",
      "Delete",
      "Report as promoting the sale of fake products?",
      "Update Your App",
      ...
      "Report as promoting spam or fraudulent?",
      "Log in to view likes",
      "If your friend is in immediate danger, call local emergency services.",
      "Create Your Channel",
      "Account options",
      ...
      "1d",
      "Report account",
      "If you're unable to receive a security code from your authentication app, you can get one by {=resend it} or use one of your {=backup codes} .",
      ...
      "1 Person",
      "Sign up • Instagram",
      "Would you like to continue with your previous settings?",
      ...
      "Incorrect Password",
      "Please copy and paste the following Broadcast ID into your intellectual property report to help us identify the reported content. Note that you can also report content through {Instagram report violation web form link} :",
      "Countries",
      "Live video",
      "Delete All?",
      "Confirmation Code",
      ...
      "Post did not upload.",
      "Message Unavailable",
      "If you report someone's product, Instagram doesn't tell them who reported it",
      ...
      "{count} active today",
      "Videos that encourage violence or attacks on anyone based on their religious, ethnic or sexual background.",
      ...
      "Register",
      "{contactsLength} of Your Contacts are on Instagram",
      "{count} likes",
      "Sun",
      "th",
      ...
      "We define violence or threat of violence as:",
      ...
      "Videos encouraging or promoting self-injury, which includes suicide, cutting and eating disorders.",
      "We won’t share information about who you are with UMD, and they won’t share your survey responses with us.",
      "If you think this post goes against our Community Standards, then someone from our review team can take a look.",
      "Video",
      "Enter confirmation code",
      "Facebook Page",
      "18 or older",
      ...
      "You're using an out-of-date version of Instagram Lite. Update now for the best experience.",
      "{learnMoreLink} about Photos of You.",
      "View Collection",
      "We define nudity or pornography as:",
      "Election pin icon",
      "New Message",
      ...
      "Get {link that reads <answers and advice>} about how to help someone with an eating disorder.",
      ...
      "Comment icon",
      "Add Photos",
      "Videos that include copyright or trademark infringement.",
      "News emails",
      "Former usernames",
      "Remove Account?",
      "Move to General",
      ...
      "Videos identifying victims of self-injury if the video attacks or makes fun of them.",
      "Continue",
      "Your Instagram Creator Account is Ready",
      "Authorize",
      "Couldn't connect to your contacts.",
      "Suggested Profiles",
      "Expired on {date}.",
      "trademark",
      ...
      "For the next 60 days, you'll only get login help emails from devices where you've used Instagram before.",
      ...
      "I Agree",
      "Comments with personal information shared to harass or blackmail people.",
      "See Hashtag",
      ...
      "Update Instagram Lite to send and receive messages on Direct.",
      "We remove:",
      "Intellectual property violation",
      "Edit Profile",
      "Enter the 6-digit code generated by your authentication app.",
      ...
      "Recent posts from # {hashtag} are currently hidden because the community has reported some content that may not meet Instagram's community guidelines. {link that reads learn more}",
      "Remove Authentication App?",
      ...
      "Live Video",
      "See All",
      "You've blocked {username}. If you stay in this group, you'll be able to see their messages and they can see yours.",
      ...
      "Regulated goods",
      "Specific threats of physical harm, theft, vandalism or financial harm.",
      "Comments promoting the use of hard drugs.",
      ...
      "This involves drugs, weapons or regulated goods",
      "Quick Reactions",
      ...
      "Backup codes are useful if you lose access to your phone number and can't receive a security code by text.",
      "Feb",
      ...
      "Privacy",
      "Countdowns",
      "Report as promoting fraudulent?",
      ...
      "Ask Parent/Guardian",
      "You can upload more than one photo or video at once.",
      ...
      "Unfollow",
      "Review and Agree",
      "You might want to recommend a helpline or call one yourself.",
      "Details of Appeal",
      ...
      "Get Instagram Lite",
      "If you need help reporting a specific photo, video, or comment posted by this account, you can {learn_more_here_link_to_help_center_guidelines}.",
      ...
      "Preparing Draft",
      "Forgot PIN?",
      "Choose a reason for reporting this product:",
      "Ways to Use Nametag",
