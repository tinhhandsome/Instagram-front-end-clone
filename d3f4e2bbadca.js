__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t,
      n,
      o = "BDClientSignalCollectionTrigger",
      ...
      O = r(d[0]).uuid(),
      E = r(d[1]).get(),
      b = Object.freeze({ NONE: 0, VITAL: 1, CRITICAL: 2 }),
      A = "hb_timestamp",
      v = (function () {
        function v() {}
        return (
          (v.startSignalCollection = (function () {
            var t = i(d[2])(
              i(d[3]).mark(function t(l) {
                var S;
                return i(d[3]).wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        if (
                          ((c = !0), r(d[4]).parseConfig(l), E.isParsingDone())
                        ) {
                          t.next = 7;
                          break;
                        }
                        return (
                          r(d[5]).logError(
                            o,
                            r(d[6]).OPERATIONS.PARSE_CONFIG_ERROR,
                      ...
                      case 7:
                        if (
                          (null != l &&
                            null != l.hbc &&
                            ((S = l.hbc),
                            (f = S.hbcbc && S.hbcbc > 0 ? S.hbcbc : f),
                            (I = S.hbvbc && S.hbvbc > 0 ? S.hbvbc : I),
                            (T = S.hbbi && S.hbbi > 0 ? S.hbbi : T)),
                          v.startHeartbeatDelayed(),
                          (n = new Promise(function (t, n) {
                            try {
                              E.getClientReputationTier() !==
                                r(d[7]).BENIGN_IGNORE &&
                                (E.getDynamicSignals().length > 0 &&
                                  (v.collectDynamicSignals(),
                                  r(d[5]).logInfo(
                                    o,
                                    r(d[6]).OPERATIONS
                                ...
                                E.getBiometricSignals().length > 0 &&
                                  (v.collectBiometricSignals(),
                                  r(d[5]).logInfo(
                                    o,
                                    r(d[6]).OPERATIONS
                          ...
                          E.getClientReputationTier() === r(d[7]).BENIGN_IGNORE)
                        ) {
                          t.next = 15;
                          break;
                        }
                        return (t.next = 13), n;
                      case 13:
                        return (t.next = 15), v.startSignalPosting();
                      case 15:
                        c &&
                          !s &&
                          !u &&
                          ...
                          r(d[5]).logWarning(
                            o,
                            r(d[6]).OPERATIONS.TRY_RESTARTING_HB
                          ),
                          v.startHeartbeatDelayed());
                      case 16:
                      case "end":
          ...
          (v.retrieveSignals = (function () {
            var t = i(d[2])(
              i(d[3]).mark(function t() {
                return i(d[3]).wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
          ...
          (v.postSignals = (function () {
            var t = i(d[2])(
              i(d[3]).mark(function t(n) {
                return i(d[3]).wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (t.next = 2), v.collectStaticSignals();
                      case 2:
                        v.postSignalsHelper(
                          r(d[9]).getSignalsAsJSONString(n),
                          b.NONE
                        ) && v.setTimestampInStorage(Date.now(), l);
                      case 3:
                      case "end":
                        return t.stop();
                    }
          ...
          (v.postSignalsHelper = function (t, n) {
            if (t.length <= 2) return !1;
            var o = E.getConfigGenerationTimeStamp(),
              l = E.getClientReputationTier(),
              c = v.encryptDataUsingAsid(O, t);
            return (
              i(d[10]).log(function () {
                return { asid: O, ct: o, rt: l, sjd: c, sid: E.sid };
              }),
              !0
            );
          }),
          (v.getInitialVector = function (t) {
            if (16 !== t.length)
              return r(d[5]).logError(o, r(d[6]).OPERATIONS.INVALID_LENGTH), "";
            for (var n = "", l = 0; l < 8; l++)
              n += String.fromCharCode(t.charCodeAt(l) ^ t.charCodeAt(8 + l));
            return n;
          }),
          (v.encryptDataUsingAsid = function (t, n) {
            if (36 !== t.length)
              return r(d[5]).logError(o, r(d[6]).OPERATIONS.INVALID_GUID), n;
            var l = t.slice(19, 23) + t.slice(24, 36),
              c = v.getInitialVector(l),
              s = new (i(d[11]))(l, "cbc");
            return s.base64Encode(s.encrypt(n, c));
          }),
          (v.startSignalPosting = (function () {
            var t = i(d[2])(
              i(d[3]).mark(function t() {
                var n, o;
                return i(d[3]).wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if (
                          ((n = v.getTimestampInStorage(l)),
                          !(
                            (o = Date.now() - n) >=
                            E.getAllTiersFlushDurationMs()
                          ))
                        ) {
                          t.next = 7;
                          break;
                        }
                        return (t.next = 5), v.postSignalsIntermittently();
                      case 5:
                        t.next = 8;
                        break;
                      case 7:
                        window.setTimeout(function () {
                          v.postSignalsIntermittently();
                        }, E.getAllTiersFlushDurationMs() - o);
                      case 8:
                      case "end":
                        return t.stop();
                    }
          ...
          (v.postSignalsIntermittently = function () {
            v.postSignals([r(d[8]).STATIC]),
          ...
          (v.setTimestampInStorage = function (t, n) {
            var l = r(d[12]).getLocalStorage();
            if (l) {
              var c = r(d[12]).setItemGuarded(l, n, t.toString());
              null != c &&
                r(d[5]).logWarning(o, r(d[6]).OPERATIONS.WEB_STORAGE, {
                  error: c.message,
                });
            } else
              r(d[5]).logWarning(o, r(d[6]).OPERATIONS.GET_LOCAL_STORAGE_ERROR);
          }),
          (v.getTimestampInStorage = function (t) {
            var n = r(d[12]).getLocalStorage();
            if (!n)
              return (
                r(d[5]).logWarning(
                  o,
                  r(d[6]).OPERATIONS.GET_LOCAL_STORAGE_ERROR
                ),
                0
              );
            var l = n.getItem(t);
            if (null == l) return 0;
            var c = Number.parseInt(l, 10);
            return Number.isFinite(c) ? c : 0;
          }),
          (v.resetHeartbeatStartedForTest = function () {
            (s = !1), (u = !1);
          }),
          (v.startHeartbeatDelayed = function () {
            if (!s && !u) {
              var t = v.getTimestampInStorage(A),
                n = Date.now() - t;
              try {
                n >= E.getHeartbeatIntervalMs()
                  ? v.startHeartbeat()
                  : (window.setTimeout(function () {
                      return v.startHeartbeat();
                    }, E.getHeartbeatIntervalMs() - n),
                    (u = !0));
              } catch (t) {
                r(d[5]).logError(o, r(d[6]).OPERATIONS.HB_START_FAILURE, {
                  lastBeatSince: n.toString(),
                  hbi: E.getHeartbeatIntervalMs().toString(),
                  e: t,
                });
              }
            }
          }),
          (v.startHeartbeat = function () {
            !s &&
              E.getHeartbeatIntervalMs() > 0 &&
              (v.collectHeartbeatTimes(f, I),
              0 !== S &&
                (window.clearInterval(S),
                r(d[5]).logWarning(o, r(d[6]).OPERATIONS.HB_ALREADY_RUNNING)),
              (S = window.setInterval(function () {
                return v.collectHeartbeatTimes(f, I);
              }, E.getHeartbeatIntervalMs())),
              (s = !0));
          }),
          (v.collectHeartbeatTimes = function (t, n) {
            (t <= 0 && n <= 0) ||
              (t > 0 && v.collectHeartbeat(b.CRITICAL),
              n > 0 && v.collectHeartbeat(b.VITAL),
              (t > 1 || n > 1) &&
                window.setTimeout(function () {
                  return v.collectHeartbeatTimes(t - 1, n - 1);
                }, 1e3 * T));
          }),
          (v.collectHeartbeat = function (t) {
            var n,
              l,
              c =
                null === E || void 0 === E
                  ? void 0
                  : null === (n = E.getHeartbeatSignal()) || void 0 === n
                  ? void 0
                  : null ===
                      (l = n.getSignalCollector(E.getClientReputationTier())) ||
                    void 0 === l
                  ? void 0
                  : l.executeSignalCollection();
            null != c
              ? (r(d[5]).logInfo(o, r(d[6]).OPERATIONS.HB_COLLECTED, {
                  urgency: t.toString(),
                }),
                v.postHeartbeat(t, c) && v.setTimestampInStorage(Date.now(), A))
              : r(d[5]).logError(o, r(d[6]).OPERATIONS.HB_COLLECTION_FAILED, {
                  urgency: t.toString(),
                });
          }),
          (v.postHeartbeat = function (t, n) {
            var o = {};
            o[r(d[13]).HEARTBEAT_V2] = [
              null === n || void 0 === n ? void 0 : n.valueOrError,
            ];
            var l = JSON.stringify(o);
            return v.postSignalsHelper(l, t);
          }),
          (v.collectStaticSignals = (function () {
            var t = i(d[2])(
              i(d[3]).mark(function t() {
                return i(d[3]).wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2),
                          v.collectSignalsOneTime(E.getStaticSignals())
                        );
                      case 2:
                      case "end":
                        return t.stop();
          ...
          (v.collectDynamicSignals = function () {
            v.stopDynamicSignalCollection(),
              (t = window.setInterval(
                      ...
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              (t.next = 2),
                              v.collectSignalsOneTime(E.getDynamicSignals())
                            );
                          case 2:
                          case "end":
                            return t.stop();
                ...
                E.getPeriodicCollectionIntervalMs()
              ));
          }),
          (v.collectBiometricSignals = function () {
            v.collectSignalsOneTime(E.getBiometricSignals());
          }),
          (v.postBiometricSignals = function () {
            v.postSignalsHelper(
              r(d[9]).getSignalsAsJSONString([r(d[8]).BIOMETRIC]),
              b.NONE
            ) && r(d[9]).clearBiometricSignals();
          }),
          (v.stopDynamicSignalCollection = function () {
            null != t && (window.clearInterval(t), (t = null));
          }),
          (v.collectSignalsOneTime = (function () {
            var t = i(d[2])(
              i(d[3]).mark(function t(n) {
                var o;
                return i(d[3]).wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        return (
                          (t.next = 4), r(d[14]).get().collectSignals(n, o)
                        );
                      case 4:
                      case "end":
                        return t.stop();
          ...
          (v.resetStartedForTest = function () {
            c = !1;
          }),
          v
        );
      })();
    (e.HEARTBEAT_TIMESTAMP_STORAGE_KEY = A),
      (e.BDClientSignalCollectionTrigger = v);
  },
  19202048,
  [
    19202049,
...
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = "BDClientConfig",
      n = (function () {
        function n() {
          (this.reputationTier = r(d[0]).BENIGN_IGNORE),
            ...
            (this.heartbeatSignal = new (r(d[1]))([], r(d[2]).HEARTBEAT_V2)),
            ...
            (this.sid = -1),
            (this.hbVersion = ""),
            (this.bufferSizeBySignalIdMap[r(d[2]).HEARTBEAT_V2] = 1);
        }
        var s = n.prototype;
        return (
          (s.setClientReputationTier = function (t) {
            return (this.reputationTier = t), this;
          }),
          (s.getClientReputationTier = function () {
            return this.reputationTier;
          }),
          (s.setStaticSignalBufferSize = function (n) {
            return (
              n > 0
                ? (this.staticSignalBufferSize = n)
                : r(d[3]).logError(t, r(d[4]).OPERATIONS.INVALID_BUFFER_SIZE, {
                    size: n.toString(),
                    type: "s",
                  }),
              this
          ...
          (s.getStaticSignalBufferSize = function () {
            return this.staticSignalBufferSize;
          }),
          (s.setDynamicSignalBufferSize = function (n) {
            return (
              n > 1
          ...
          (s.getDynamicSignalBufferSize = function () {
            return this.dynamicSignalBufferSize;
          }),
          (s.setBiometricSignalBufferSize = function (n) {
            return (
              n > 1
          ...
          (s.setHeartbeatVersion = function (t) {
            return (this.hbVersion = t), this;
          }),
          (s.getHeartbeatVersion = function () {
            return this.hbVersion;
          }),
          (s.getBiometricSignalBufferSize = function () {
            return this.biometricSignalBufferSize;
          }),
          (s.setConfigGenerationTimeStamp = function (t) {
            return (this.signalConfigGenerationTimeStampMs = t), this;
          }),
          (s.getConfigGenerationTimeStamp = function () {
            return this.signalConfigGenerationTimeStampMs;
          }),
          (s.setHeartbeatIntervalMinutes = function (t) {
            return (this.heartbeatIntervalMs = 60 * t * 1e3), this;
          }),
          (s.getHeartbeatIntervalMs = function () {
            return this.heartbeatIntervalMs;
          }),
          (s.setAllTiersFlushDurationMinutes = function (n) {
            return (
              n > 0
                ? (this.allTiersFlushDurationMs = 60 * n * 1e3)
                : r(d[3]).logError(t, r(d[4]).OPERATIONS.INVALID_DURATION, {
                    size: n.toString(),
                    type: "fda",
                  }),
              this
          ...
          (s.getAllTiersFlushDurationMs = function () {
            return this.allTiersFlushDurationMs;
          }),
          (s.getFlushDurationByReputationTierMs = function () {
            return this.reputationTier === r(d[0]).BENIGN
              ? this.allTiersFlushDurationMs
              : this.suspiciousTiersFlushDurationMs;
          }),
          (s.addMultipleSignalsToClientConfig = function (t) {
            var n = this;
            return (
              t.forEach(function (t) {
                return n.addSignalToClientConfig(t);
              }),
              this
            );
          }),
          (s.addSignalToClientConfig = function (t) {
            var n = t.getSignalFlags(),
              s = t.getSignalId();
            if (s === r(d[2]).HEARTBEAT) return this;
            var u = new (r(d[1]))(n, s);
            return s === r(d[2]).HEARTBEAT_V2
              ? ((this.heartbeatSignal = u), this)
              : (n.includes(r(d[5]).DYNAMIC)
                  ? n.includes(r(d[5]).BIOMETRIC)
                    ? this.biometricSignals.push(u)
                    : this.dynamicSignals.push(u)
                  : this.staticSignals.push(u),
                t.getBufferSize() > 0 &&
                  (this.bufferSizeBySignalIdMap[
                    t.getSignalId()
                  ] = t.getBufferSize()),
          ...
          (s.setPeriodicCollectionIntervalSeconds = function (n) {
            return (
              n > 0
                ? (this.periodicCollectionIntervalMs = 1e3 * n)
                : r(d[3]).logError(t, r(d[4]).OPERATIONS.INVALID_DURATION, {
          ...
          (s.getPeriodicCollectionIntervalMs = function () {
            return this.periodicCollectionIntervalMs;
          }),
          (s.getDynamicSignals = function () {
            return this.dynamicSignals;
          }),
          (s.getStaticSignals = function () {
            return this.staticSignals;
          }),
          (s.getBiometricSignals = function () {
            return this.biometricSignals;
          }),
          (s.getHeartbeatSignal = function () {
            return this.heartbeatSignal;
          }),
          (s.getBufferSizeBySignalId = function (t) {
            return this.bufferSizeBySignalIdMap[t];
          }),
          (s.setParsingDone = function (t) {
            this.parsingDone = t;
          }),
          (s.isParsingDone = function () {
      ...
      u = {
        get: function () {
          return null == s && (s = new n()), s;
        },
      };
    m.exports = u;
  },
  19202050,
  [19202054, 19202061, 19202059, 19202052, 19202053, 19202062]
);
__d(
  function (g, r, i, a, m, e, d) {
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = (function () {
      function t(t, n) {
        (this.signalFlags = t), (this.signalType = n);
      }
      var n = t.prototype;
      return (
        (n.getSignalCollector = function (t) {
          if (this.canExecuteForReputationTier(t)) {
            var n;
            return null === (n = r(d[0])[this.signalType]) || void 0 === n
              ? void 0
              : n.get(this.signalFlags);
          }
          return null;
        }),
        (n.canExecuteForReputationTier = function (t) {
          return (
            this.signalType === r(d[1]).HEARTBEAT_V2 ||
            this.signalFlags.includes(t)
          );
        }),
        (n.getBufferConfig = function () {
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = (function (t) {
        function n() {
          return t.call(this, o.signalType) || this;
        }
        r(d[0])(n, t);
        return (
          (n.prototype.executeSignalCollection = function () {
            this.throwIfNotInitialized();
            var t = !!navigator.webdriver;
            return {
              valueOrError: new (r(d[1]))(Date.now(), this.getContext(), t),
            };
          }),
          n
        );
      ...
      n = null,
      o = {
        signalType: r(d[3]).WEBDRIVER,
        get: function () {
          return null == n && (n = new t()), n;
        },
      };
    m.exports = o;
  },
  19202065,
  [9764914, 19202075, 19202076, 19202059]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = (function (t) {
      function n(n, u, c) {
        return t.call(this, n, u, c, r(d[1]).VALUE_TYPES.BOOLEAN) || this;
      }
      return r(d[0])(n, t), n;
    })(r(d[1]).SignalValueTypeDef);
    m.exports = t;
  },
  19202075,
  [9764914, 19202077]
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = {
      ...
      n = (function () {
        function n(t, n, l, u, S) {
          (this.$SignalValueTypeDef1 = t),
            (this.$SignalValueTypeDef2 = n),
            (this.$SignalValueTypeDef3 = l),
            (this.$SignalValueTypeDef4 = u),
            (this.$SignalValueTypeDef5 = null != S ? S : 0);
        }
        var l = n.prototype;
        return (
          (l.getTimeStampMS = function () {
            return this.$SignalValueTypeDef1;
          }),
          (l.getSignalContext = function () {
            return this.$SignalValueTypeDef2;
          }),
          (l.getSignalValue = function () {
            return this.$SignalValueTypeDef3;
          }),
          (l.getSignalValueType = function () {
            return this.$SignalValueTypeDef4;
          }),
          (l.isEqual = function (n, l) {
            if (null == n)
              return (
                r(d[0]).logWarning(
                  "SignalValueTypeDef",
                  r(d[1]).OPERATIONS.SIGNAL_VALUE_NULL
                ),
                !1
              );
            if (this.getSignalValueType() !== n.getSignalValueType()) return !1;
            if (
              this.getSignalValueType() === t.ERROR &&
              n.getSignalValueType() === t.ERROR
            )
              return this.equalValue(n);
            var u = !1;
            return (
              l.has(r(d[2]).EQUAL_BY_VALUE) && (u = this.equalValue(n)),
              l.has(r(d[2]).EQUAL_BY_CONTEXT) &&
                (u =
                  u &&
                  null != this.getSignalContext() &&
                  null != n.getSignalContext() &&
                  this.getSignalContext().getSignalValueContextName() ===
                    n.getSignalContext().getSignalValueContextName()),
              l.has(r(d[2]).EQUAL_BY_TIMESTAMP) &&
                (u =
                  u &&
                  Math.abs(this.getTimeStampMS() - n.getTimeStampMS()) <=
                    this.$SignalValueTypeDef5),
              u
            );
          }),
          (l.equalValue = function (t) {
          ...
          (l.toJSON = function (t) {
            ...
            return (
              t &&
                ((n.t = this.$SignalValueTypeDef1 / 1e3),
                null != this.$SignalValueTypeDef2 &&
                  (n.ctx = this.$SignalValueTypeDef2)),
              null == this.$SignalValueTypeDef3
                ? (n.e = new (r(d[3]).SignalErrorValueTypeDef)(r(d[4]).NULL))
                : this.addValueOrErrorToJSON(n),
              n
            );
          }),
          (l.addValueOrErrorToJSON = function (t) {
            if (!this.isPrimitiveType())
              throw new Error("Must implement in the subclasses");
            t.v = this.$SignalValueTypeDef3;
          }),
          (l.isPrimitiveType = function () {
  ...
  19202077,
  [19202052, 19202053, 19202062, 19202078, 19202079]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var n = {
      logInfo: function (o, t, l, c) {
        n.log(o, i(d[0]).INFO, t, l, c);
      },
      logWarning: function (o, t, l, c) {
        n.log(o, i(d[0]).WARNING, t, l, c);
      },
      logError: function (o, t, l, c) {
        n.log(o, i(d[0]).ERROR, t, l, c);
      },
      log: function (o, t, l, c, E) {
        if (
          (void 0 === c && (c = {}),
          r(d[1]).coinflip(n.getFlipSamplingByOperation(l)))
        ) {
          if (null === c) throw new Error("opeartion info null");
          (c.source = o),
            i(d[2]).log(function () {
              return {
                operation: l,
      ...
      getFlipSamplingByOperation: function (n) {
        var o = r(d[4]).OPERATIONS;
        switch (n) {
          case o.APPEND_SIGNAL:
          case o.HB_COLLECTED:
          case o.GET_LOCAL_STORAGE_ERROR:
          case o.WEB_STORAGE:
          case o.SIGNAL_NOT_IMPLEMENTED:
          case o.BIOMETRIC_SIGNAL_COLLECTION_STARTED:
            return 1e3;
          default:
            return 1;
        }
  ...
  19202052,
  [19202080, 19202081, 19202082, 19202083, 19202053]
);
__d(
  function (g, r, i, a, m, e, d) {
    m.exports = Object.freeze({
  ...
  function (g, r, i, a, m, e, d) {
    ...
    var o = { falco: !0, pigeon: !1 },
      n = (function () {
        ...
        return (
          (n.log = function (n) {
            r(d[0]).FalcoLogger.log("bd_operation", n(), {}, o);
          }),
          n
        );
      })();
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = 500,
      n = (function () {
        function n(n, o, l) {
          (this.$SignalErrorValueTypeDef1 = n),
            (this.$SignalErrorValueTypeDef2 = o),
            null != l && (this.$SignalErrorValueTypeDef3 = l.substr(0, t));
        }
        var o = n.prototype;
        return (
          (o.getErrorCode = function () {
            return this.$SignalErrorValueTypeDef1;
          }),
          (o.getErrorName = function () {
            return this.$SignalErrorValueTypeDef2;
          }),
          (o.getErrorDetails = function () {
            return this.$SignalErrorValueTypeDef3;
          }),
          (o.isEqual = function (t) {
            return (
              this.$SignalErrorValueTypeDef1 === t.getErrorCode() &&
              this.$SignalErrorValueTypeDef3 === t.getErrorDetails() &&
              this.$SignalErrorValueTypeDef2 === t.getErrorName()
            );
          }),
          (o.toJSON = function () {
            var t = {};
            switch (
              ((t.ec = this.$SignalErrorValueTypeDef1),
              this.$SignalErrorValueTypeDef1)
            ) {
              case r(d[0]).UNKNOWN:
                (t.en = this.$SignalErrorValueTypeDef2),
                  (t.es = this.$SignalErrorValueTypeDef3);
            }
            return t;
          }),
          n
    ...
    m.exports = { SignalErrorValueTypeDef: n };
  },
  19202078,
  [19202079]
);
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var n = (function () {
      ...
      return (
                ...
                function (n) {
                  for (;;)
                    switch ((n.prev = n.next)) {
                      case 0:
                        return (n.next = 2), this.executeSignalCollection();
                      case 2:
        ...
        (n.getSanitizedURI = function () {
          var n = window.location.href,
            t = n.indexOf("?");
          return t < 0 ? n : n.substring(0, t);
        }),
        (t.getContext = function () {
          return new (r(d[2]))(n.getSanitizedURI());
        }),
        (t.throwIfNotInitialized = function () {
          if (!(this.signalType in r(d[3])))
  ...
  19202076,
  [9830402, 9830403, 19202084, 19202064]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = (function () {
      ...
      return (
        (t.prototype.getSignalValueContextName = function () {
          return this.cn;
        }),
        t
      );
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = (function (t) {
        ...
        return (
          (n.prototype.executeSignalCollection = function () {
            this.throwIfNotInitialized();
            var t = navigator.plugins ? navigator.plugins.length : -1;
            return {
              valueOrError: new (r(d[1]))(Date.now(), this.getContext(), t),
            };
          }),
  ...
  19202066,
  [9764914, 19202085, 19202076, 19202059]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = (function (t) {
      function n(n, u, c) {
        return t.call(this, n, u, c, r(d[1]).VALUE_TYPES.NUMBER) || this;
      }
      return r(d[0])(n, t), n;
    })(r(d[1]).SignalValueTypeDef);
    m.exports = t;
  ...
  function (g, r, i, a, m, e, d) {
    ...
    var t = (function (t) {
        ...
        return (
          (n.prototype.executeSignalCollection = function () {
            this.throwIfNotInitialized();
            var t = navigator.mimeTypes ? navigator.mimeTypes.length : -1;
            return {
              valueOrError: new (r(d[1]))(Date.now(), this.getContext(), t),
            };
          }),
      ...
      n = null,
      o = {
        signalType: r(d[3]).MIME_TYPE_COUNT,
        get: function () {
          return null == n && (n = new t()), n;
        },
      };
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = (function (t) {
        ...
        return (
          (n.prototype.executeSignalCollection = function () {
            this.throwIfNotInitialized();
            var t = [].concat(navigator.languages);
            return {
              valueOrError: new (r(d[1]))(
                Date.now(),
                this.getContext(),
                new (r(d[2]))(t)
              ),
  ...
  19202068,
  [9764914, 19202086, 19202087, 19202076, 19202059]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = (function (t) {
      function n(n, u, l) {
        return t.call(this, n, u, l, r(d[1]).VALUE_TYPES.CUSTOM_OBJECT) || this;
      }
      r(d[0])(n, t);
      var u = n.prototype;
      return (
        (u.equalValue = function (t) {
          return this.getSignalValue().isEqual(t.getSignalValue());
        }),
        (u.addValueOrErrorToJSON = function (t) {
          t[r(d[1]).BD_VALUE] = this.getSignalValue().toJSON();
        }),
        n
      );
    })(r(d[1]).SignalValueTypeDef);
      ...
      return (
        ...
        (n.isEqual = function (n) {
          ...
          for (var s = 0; s < this.strings.length; s++)
            if (this.strings[s] !== n.strings[s]) return !1;
          return !0;
        }),
        t
      );
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = (function (t) {
        ...
        return (
          (n.prototype.executeSignalCollection = function () {
            ...
            if (
              ...
              var o = navigator.connection.rtt;
              n = new (r(d[1]))(Date.now(), this.getContext(), o);
            } else
              n = new (r(d[2]))(
                Date.now(),
                this.getContext(),
                new (r(d[3]).SignalErrorValueTypeDef)(
                  r(d[4]).NOT_SUPPORTED,
      ...
      n = null,
      o = {
        signalType: r(d[6]).CONNECTION_RTT,
        get: function () {
          return null == n && (n = new t()), n;
        },
      };
  ...
  19202069,
  [9764914, 19202085, 19202088, 19202078, 19202079, 19202076, 19202059]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = (function (t) {
      function n(n, u, l) {
        return t.call(this, n, u, l, r(d[1]).VALUE_TYPES.ERROR) || this;
      }
      r(d[0])(n, t);
      var u = n.prototype;
      return (
        ...
        (u.addValueOrErrorToJSON = function (t) {
          t[r(d[1]).BD_ERROR] = this.getSignalValue().toJSON();
        }),
        n
      );
    })(r(d[1]).SignalValueTypeDef);
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = (function (t) {
      ...
      n = null,
      o = {
        signalType: r(d[4]).WINDOW_OUTER_DIMENSION,
        get: function () {
          return null == n && (n = new t()), n;
        },
      };
  ...
  19202070,
  [9764914, 19202086, 19202089, 19202076, 19202059]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = (function () {
      ...
      return (
        ...
        (h.isEqual = function (h) {
          return (
            h instanceof t && this.width === h.width && this.height === h.height
          );
        }),
        t
      );
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = (function (t) {
      ...
      n = null,
      o = {
        signalType: r(d[6]).NOTIFICATION_PERMISSION,
        get: function () {
          return null == n && (n = new t()), n;
        },
      };
  ...
  19202071,
  [9764914, 19202090, 19202088, 19202078, 19202079, 19202076, 19202059]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = (function (t) {
      function n(n, u, c) {
        return t.call(this, n, u, c, r(d[1]).VALUE_TYPES.STRING) || this;
      }
      return r(d[0])(n, t), n;
    })(r(d[1]).SignalValueTypeDef);
    m.exports = t;
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var t = (function (t) {
      ...
      n = null,
      o = {
        signalType: r(d[3]).NAVIGATOR_VENDOR,
        get: function () {
          return null == n && (n = new t()), n;
        },
      };
  ...
  19202072,
  [9764914, 19202090, 19202076, 19202059]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = (function (t) {
      ...
      n = null,
      o = {
        signalType: r(d[3]).NAVIGATOR_PLATFORM,
        get: function () {
          return null == n && (n = new t()), n;
        },
      };
...
__d(
          ...
          (n.prototype.executeSignalCollection = function () {
            return {
              valueOrError: new (r(d[1]))(
                Date.now(),
                this.getContext(),
                new (r(d[2]))(i(d[3]).get().getHeartbeatVersion())
              ),
            };
          }),
          n
  ...
  19202074,
  [9764914, 19202086, 19202091, 19202050, 19202076, 19202059]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = (function (t) {
      function n(n) {
        var o;
        return (o = t.call(this) || this), (o.id = ""), (o.id = n), o;
      }
      r(d[0])(n, t);
      return (
...
__d(
        ...
        try {
          ...
          if (
            (o.forEach(function (t, s) {
              return n.push(new (r(d[0]))(s, t));
            }),
            0 === o.size)
          )
            return void r(d[1]).logError(
              "BDServerConfig",
              r(d[2]).OPERATIONS.EMPTY_SIGNAL_CONFIG
            );
          r(d[3])
            .get()
            .setClientReputationTier(t.rt)
            .addMultipleSignalsToClientConfig(n)
            .setPeriodicCollectionIntervalSeconds(t.i)
            .setConfigGenerationTimeStamp(s.t)
            .setAllTiersFlushDurationMinutes(t.fd)
            .setHeartbeatIntervalMinutes(t.hbc.hbi)
            .setStaticSignalBufferSize(t.sbs)
            .setDynamicSignalBufferSize(t.dbs)
            .setBiometricSignalBufferSize(t.bbs)
            .setSID(t.sid)
            .setHeartbeatVersion(t.hbc.hbv)
            .setParsingDone(!0);
        } catch (t) {
          r(d[1]).logError(
            "BDServerConfig",
            r(d[2]).OPERATIONS.PARSE_CONFIG_ERROR,
            { e: t }
          );
        }
      },
  ...
  19202051,
  [19202093, 19202052, 19202053, 19202050]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var s = (function () {
      ...
      var t = s.prototype;
      return (
        (t.getSignalId = function () {
          return this.signalId;
        }),
        (t.getSignalFlags = function () {
          var s = this;
          if (0 === this.parsedSignalFlags.length) {
            Object.keys(r(d[0])).forEach(function (t) {
              (r(d[0])[t] & s.signalFlags) === r(d[0])[t] &&
                s.parsedSignalFlags.push(r(d[0])[t]);
            });
          }
          return (
            0 === this.parsedSignalFlags.length &&
              r(d[1]).logError(
                "BDServerSignalConfig",
                r(d[2]).OPERATIONS.SIGNAL_FLAGS_MISSING,
                {
  ...
  19202093,
  [19202062, 19202052, 19202053]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var t = Object.freeze({ STATIC: 0, DYNAMIC: 1, BIOMETRIC: 2 });
    m.exports = t;
  },
  19202055,
  []
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var n = {
        ...
        if (!(n in r(d[0]))) {
          ...
          void 0 !== t && (u = t),
            (r(d[0])[n] = {
              values: [],
              max_buffer_size: u,
              signal_flags: null !== (o = l) && void 0 !== o ? o : [],
            });
        }
      },
      clearBuffer: function (n) {
        if (!(n in r(d[0])))
          throw new Error(
      ...
      appendSignal: function (n, t) {
        if (!(n in r(d[0])))
          throw (
            (r(d[2]).logError(
              "BDSignalBuffer",
              r(d[3]).OPERATIONS.APPEND_SIGNAL_FAIL,
              { id: n.toString() }
            ),
        ...
        var l = r(d[0])[n],
          o = l.max_buffer_size;
        l.values.length >= o &&
          (l.signal_flags.includes(r(d[1]).BIOMETRIC) || l.values.shift()),
          l.values.push(t),
          r(d[2]).logInfo("BDSignalBuffer", r(d[3]).OPERATIONS.APPEND_SIGNAL, {
            id: n.toString(),
          });
      },
      clearBiometricSignals: function () {
        r(d[4])
          .get()
          .getBiometricSignals()
          .forEach(function (t) {
            t.signalType in r(d[0]) && n.clearBuffer(t.signalType);
          });
      },
      getLastSignalFormatBySignalId: function (n) {
        var t,
          l = r(d[0])[n],
          o =
            null === l || void 0 === l
              ? void 0
              : null === (t = l.values) || void 0 === t
              ? void 0
              : t.length;
        return null != o && o > 0 ? l.values[o - 1] : { valueOrError: void 0 };
      },
      retrieveSignal: function (n) {
        return r(d[0])[n].values;
      },
      retrieveSignals: function (n) {
        var t = {},
          l = !0,
          o = !1,
          u = void 0;
        try {
          for (
            var s, f = n[Symbol.iterator]();
            !(l = (s = f.next()).done);
            l = !0
          ) {
            var c = s.value;
            c in r(d[0]) &&
              (t[c] = this.retrieveSignal(c).map(function (n) {
                return n.valueOrError;
              }));
          }
        } catch (n) {
          (o = !0), (u = n);
      ...
      getSignalsAsJSONString: function (n) {
        var t = this._getSignalIdsByCollectionType(n);
        return JSON.stringify(this.retrieveSignals(t));
      },
      _getSignalIdsByCollectionType: function (n) {
        var t = r(d[4]).get(),
          l = [];
        return (
          n.forEach(function (n) {
            switch (n) {
              case r(d[5]).STATIC:
                l = [].concat(r(d[6])(l), r(d[6])(t.getStaticSignals()));
                break;
              case r(d[5]).DYNAMIC:
                l = [].concat(r(d[6])(l), r(d[6])(t.getDynamicSignals()));
                break;
              case r(d[5]).BIOMETRIC:
                l = [].concat(r(d[6])(l), r(d[6])(t.getBiometricSignals()));
            }
          }),
          l.map(function (n) {
            return n.signalType;
  ...
  19202056,
  [19202064, 19202062, 19202052, 19202053, 19202050, 19202055, 9764896]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    ...
    var n = { falco: !0, pigeon: !1 },
      o = (function () {
        ...
        return (
          (o.log = function (o) {
            r(d[0]).FalcoLogger.log("bd_pdc_signals", o(), {}, n);
          }),
          o
        );
      })();
    ...
    (t.prototype = {
      ...
      encryptECB: function (t) {
        ...
        for (var o = Math.ceil(t.length / 8), h = "", s = 0; s < o; s++) {
          ...
          if (n.length < 8) for (var c = 8 - n.length; 0 < c--; ) n += "\0";
          var f,
            u,
            l = this.split64by32(n);
          (f = l[0]),
            (u = l[1]),
      ...
      encryptCBC: function (t, o) {
        ...
        var h,
          s,
          n,
          c = Math.ceil(t.length / 8);
        (h = (n = this.split64by32(o))[0]), (s = n[1]);
        for (var f = "", u = 0; u < c; u++) {
          var l = t.substr(8 * u, 8);
          if (l.length < 8) for (var C = 8 - l.length; 0 < C--; ) l += "\0";
          var x, p, y;
      ...
      decryptECB: function (t) {
        for (var o = Math.ceil(t.length / 8), h = "", s = 0; s < o; s++) {
          ...
          if (n.length < 8)
            throw new Error(
              "Зашифрованная строка повреждена: длинна зашифрованной строки должна быть кратна 8 баыйтам."
            );
          var c, f, u;
      ...
      decryptCBC: function (t, o) {
        var h,
          ...
          c,
          f,
          u = Math.ceil(t.length / 8);
        (h = (f = this.split64by32(o))[0]), (s = f[1]);
        for (var l = "", C = 0; C < u; C++) {
          var x = t.substr(8 * C, 8);
          if (x.length < 8)
            throw new Error(
              "Зашифрованная строка повреждена: длинна зашифрованной строки должна быть кратна 8 байтам."
            );
          var p, y, b;
      ...
      num2block32: function (t) {
        return (
          String.fromCharCode(t >>> 24) +
          String.fromCharCode((t << 8) >>> 24) +
          String.fromCharCode((t << 16) >>> 24) +
          String.fromCharCode((t << 24) >>> 24)
        );
      },
      xor: function (t, o) {
      ...
      utf8Decode: function (t) {
        for (var o = "", h = 0; h < t.length; h++) {
          ...
          s < 128
            ...
            : s > 127 && s < 2048
            ? ((o += String.fromCharCode((s >> 6) | 192)),
              (o += String.fromCharCode((63 & s) | 128)))
            : ((o += String.fromCharCode((s >> 12) | 224)),
      ...
      utf8Encode: function (t) {
        for (var o = "", h = 0, s = 0, n = 0, c = 0; h < t.length; )
          (s = t.charCodeAt(h)) < 128
            ? ((o += String.fromCharCode(s)), h++)
            : s > 191 && s < 224
            ? ((n = t.charCodeAt(h + 1)),
      ...
      base64Encode: function (t) {
        for (var o, h, s, n, c, f, u, l = "", C = 0; C < t.length; )
          (n = (o = t.charCodeAt(C++)) >> 2),
            ...
            (l =
              l +
              this.keyStr.charAt(n) +
              this.keyStr.charAt(c) +
              this.keyStr.charAt(f) +
              this.keyStr.charAt(u));
        return l;
      },
      base64Decode: function (t) {
        ...
        for (t = t.replace(/[^A-Za-z0-9\+\/\=]/g, ""); l < t.length; )
          (o =
            (this.keyStr.indexOf(t.charAt(l++)) << 2) |
            ((n = this.keyStr.indexOf(t.charAt(l++))) >> 4)),
            (h =
              ((15 & n) << 4) |
              ((c = this.keyStr.indexOf(t.charAt(l++))) >> 2)),
...
__d(
  function (g, r, i, a, m, e, d) {
    ...
    var n = (function () {
        ...
        var l = n.prototype;
        return (
          (l.collectSignals = (function () {
            var n = r(d[0])(
              r(d[1]).mark(function n(l, t) {
                var u,
                  o = this;
                return r(d[1]).wrap(function (n) {
                  for (;;)
                    switch ((n.prev = n.next)) {
                      case 0:
                        return (
                          ...
                          l.forEach(function (n) {
                            n.signalFlags.includes(r(d[2]).BIOMETRIC)
                              ? o.$SignalCollectionManager1(n, t)
                              : u.push(o.$SignalCollectionManager2(n, t));
                          }),
                          (n.next = 4),
                          Promise.all(u)
                        );
          ...
          (l.isEqualToLastCollectedSignal = function (n, l) {
            var t = r(d[3]).getLastSignalFormatBySignalId(l.signalType);
            return (
              null != t.valueOrError &&
              n.isEqual(t.valueOrError, new Set(l.signalFlags))
            );
          }),
          (l.getCircularBufferSize = function (n) {
            var l = r(d[4]).get(),
              t = l.getBufferSizeBySignalId(n.signalType);
            return null != t && l.getBufferSizeBySignalId(n.signalType) > 0
              ? t
              : n.signalFlags.includes(r(d[2]).DYNAMIC)
              ? n.signalFlags.includes(r(d[2]).BIOMETRIC)
                ? l.getBiometricSignalBufferSize()
                : l.getDynamicSignalBufferSize()
              : l.getStaticSignalBufferSize();
          }),
          (l.$SignalCollectionManager2 = (function () {
            var n = r(d[0])(
              r(d[1]).mark(function n(l, t) {
                var u, o;
                return r(d[1]).wrap(
                  function (n) {
                    for (;;)
                      switch ((n.prev = n.next)) {
                        case 0:
                          if (null == (u = l.getSignalCollector(t))) {
                            n.next = 13;
                            break;
                          }
                          return (
                            null == l.getBufferConfig() &&
                              r(d[3]).initialize(
                                l.signalType,
                                this.getCircularBufferSize(l),
                                l.signalFlags
                              ),
                            (n.prev = 3),
                            (n.next = 6),
                            u.executeAsyncSignalCollection()
                          );
                        case 6:
                          (o = n.sent).valueOrError &&
                            !this.isEqualToLastCollectedSignal(
                              o.valueOrError,
                              l
                            ) &&
                            r(d[3]).appendSignal(l.signalType, o),
                            (n.next = 13);
                          break;
                        case 10:
                          (n.prev = 10),
          ...
          (l.$SignalCollectionManager1 = function (n, l) {
            var t = n.getSignalCollector(l);
            null != t &&
              t instanceof r(d[7]) &&
              (null == n.getBufferConfig() &&
                r(d[3]).initialize(
                  n.signalType,
      ...
      t = {
        get: function () {
          return null == l && (l = new n()), l;
        },
      };
    m.exports = t;
  },
  19202060,
  [9830402, 9830403, 19202062, 19202056, 19202050, 19202052, 19202053, 19202094]
);
__d(
  function (g, r, i, a, m, e, d) {
    "use strict";
    var n = (function (n) {
      ...
      var o = t.prototype;
      return (
        (o.listenForSignals = function () {
          throw new Error(
            "Child class responsibility to implement listenForSignals"
          );
        }),
        (o.executeSignalCollection = function () {
          throw new Error(
